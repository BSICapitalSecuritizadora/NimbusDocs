...
<form method="post" action="/portal/submissions" enctype="multipart/form-data" id="submissionForm">
    ...
    <div class="nd-stepper">
        <div class="nd-step active" data-target="1">
            <div class="nd-step-indicator">1</div>
            <div class="nd-step-label">Dados Iniciais</div>
        </div>
        <div class="nd-step" data-target="2">
            <div class="nd-step-indicator">2</div>
            <div class="nd-step-label">Sócios</div>
        </div>
        <div class="nd-step" data-target="3">
            <div class="nd-step-indicator">3</div>
            <div class="nd-step-label">Documentos</div>
        </div>
    </div>

    <!-- STEP 1: Dados da Empresa, Responsável e Compliance -->
    <div class="wizard-step active" data-step="1">
        ...
        <div class="wizard-actions d-flex justify-content-end">
            <button type="button" class="nd-btn nd-btn-lg nd-btn-primary px-4 btn-next" data-next="2">
                Próximo <i class="bi bi-arrow-right ms-2"></i>
            </button>
        </div>
    </div>

    <!-- STEP 2: Composição Societária -->
    <div class="wizard-step" data-step="2">
        ...
        <div class="wizard-actions d-flex justify-content-between">
            <button type="button" class="nd-btn nd-btn-lg nd-btn-outline px-4 btn-prev" data-prev="1">
                <i class="bi bi-arrow-left me-2"></i> Voltar
            </button>
            <button type="button" class="nd-btn nd-btn-lg nd-btn-primary px-4 btn-next" data-next="3">
                Próximo <i class="bi bi-arrow-right ms-2"></i>
            </button>
        </div>
    </div>
    ...
    <div class="wizard-step" data-step="3">
        ...
        <div class="wizard-actions d-flex justify-content-between">
            <button type="button" class="nd-btn nd-btn-lg nd-btn-outline px-4 btn-prev" data-prev="2">
                <i class="bi bi-arrow-left me-2"></i> Voltar
            </button>
