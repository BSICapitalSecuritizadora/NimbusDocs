...
<div class="row justify-content-center">
    <div class="col-lg-12">
                        ...
                        <div class="nd-card-body">
                            ...
                            <div class="nd-input-group">
                                <select class="nd-input form-select <?= isset($errors['status']) ? 'is-invalid' : '' ?>"
                                    id="status" name="status" style="padding-left: 2.5rem;">
                                ...
                                <i class="bi bi-ui-checks nd-input-icon"></i>
                            </div>
                            ...
                            <div class="small text-muted mt-2">
                                Defina o estado atual do acesso deste usuário ao portal.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Tokens Section (Edit Only) - Outside Main Form -->
        <?php if ($isEdit): ?>
            <div class="row">
                <div class="col-lg-8">
                    <div class="nd-card mb-4">
                        <div class="nd-card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-key" style="color: var(--nd-gold-500);"></i>
                        ...
                        <div class="nd-card-body">
                            ...
                            <div class="p-3 mb-4 rounded" style="background: var(--nd-gray-50); border: 1px dashed var(--nd-gray-300);">
                                <form method="post" action="/admin/portal-users/<?= (int)$user['id'] ?>/tokens" class="row g-3 align-items-end">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="nd-input-group">
                                            <select class="nd-input form-select" id="validity" name="validity" style="padding-left: 2.5rem;">
                                                <option value="1h">1 hora</option>
                                                <option value="24h" selected>24 horas</option>
                                                <option value="7d">7 dias</option>
                                            </select>
                                            <i class="bi bi-hourglass-split nd-input-icon"></i>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                            ...
                            <!-- Tokens List -->
                            <h6 class="fw-semibold text-dark mb-3 small text-uppercase ls-1">Histórico de códigos gerados</h6>
